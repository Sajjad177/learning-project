    ...
    <div>
      <nav className="flex items-center justify-between bg-[#393E46] px-4 py-2 text-white">
        ...
        <ul className="flex items-center justify-between gap-6 text-slate-900">
          <li className="cursor-pointer rounded-full px-6 py-2 text-white transition duration-300 ease-in-out transform hover:bg-sky-600 hover:scale-105">
            Home
          </li>
          <li className="cursor-pointer rounded-full px-6 py-2 text-white transition duration-300 ease-in-out transform hover:bg-sky-600 hover:scale-105">
            Services
        ...
        <div>
          <li className="cursor-pointer flex gap-2 list-none rounded-full px-6 py-2 text-white transition duration-300 ease-in-out transform hover:bg-sky-600 hover:scale-105">
            <svg
              className="w-4"
              viewBox="0 0 15 15"
              version="1.1"
